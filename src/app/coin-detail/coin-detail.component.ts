...
export class CoinDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.params.subscribe((val: { [x: string]: string; })=>{
      this.coinId = val['id'];
    });
    this.getCoinData();
  ...
  getCoinData(){
    ...
    .subscribe((res: { market_data: { current_price: { inr: any; usd: any; }; market_cap: { inr: any; usd: any; }; }; })=>{
